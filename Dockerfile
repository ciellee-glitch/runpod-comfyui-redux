...
RUN python3 -c "import urllib.request, os, facexlib; d=os.path.dirname(facexlib.__file__)+'/weights/'; [urllib.request.urlretrieve(u,d+n) or print('ok:',n) for u,n in [('https://github.com/xinntao/facexlib/releases/download/v0.1.0/detection_Resnet50_Final.pth','detection_Resnet50_Final.pth'),('https://github.com/xinntao/facexlib/releases/download/v0.2.2/parsing_parsenet.pth','parsing_parsenet.pth'),('https://github.com/xinntao/facexlib/releases/download/v0.2.0/parsing_bisenet.pth','parsing_bisenet.pth')]]"
